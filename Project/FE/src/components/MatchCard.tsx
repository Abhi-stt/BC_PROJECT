    ...
    <div className="card overflow-hidden fade-in">
      <div className="relative">
        ...
        <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1">
          <span className="text-sm font-semibold text-gray-800">{user.compatibilityScore}% Match</span>
        </div>
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm font-semibold text-green-600">{user.compatibilityScore}%</span>
          </div>
