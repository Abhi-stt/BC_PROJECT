...
import { Bell, Settings, User, LogOut, Shield, X, Check, MessageSquare, Bot } from 'lucide-react';
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button 
                ...
                className="p-2 text-gray-600 hover:text-saffron transition-colors relative"
              >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="w-10 h-10 bg-gradient-to-r from-saffron to-orange-500 rounded-full flex items-center justify-center">
